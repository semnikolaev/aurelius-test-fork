...
class ArchimateHierarchicalLayout(HierarchicalLayout):
    ...
    @staticmethod
    def get_coordinates(model, dpi=80, rankdir='BT', nodesep=1, ranksep=2, node_width=0.1, node_height=0.1, **kwargs):
        prepared_model = ArchimateHierarchicalLayout._prepare_model(model)
